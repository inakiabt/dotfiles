...
gone_raw_notification_changes() {
    ...
    query="select * from raw_notification where object_id='$notificationId' order by updated_at desc;"

    outputPath=~/tmp/redshift
    outputFile=$outputPath/notification-$productId.html
